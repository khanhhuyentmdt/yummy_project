...
export default function CreateMaterialPage({ onCancel, onSaved }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        unit: form.unit,
        notes: form.notes,
        batch_management: form.batch_management,
        status: form.status,
      };
      ...
      if (imageFileRef.current) {
        ...
        await api.patch(`materials/${newId}/`, fd);
      }

      const detail = await api.get(`materials/${newId}/`);
      saved = detail.data;
  ...
  const requestSubmit = () => {
    ...
    if (window.confirm("Bạn có chắc muốn lưu nguyên vật liệu này không?")) {
      handleSubmit();
    }
  };
    ...
    <div>
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                {!errors.group &&
                  ...
                  materialGroups.length === 0 && (
                    <p className="mt-1 text-xs text-amber-600">
                      Chưa có nhóm nguyên vật liệu. Hãy tạo nhóm trước khi thêm
                      nguyên vật liệu.
                    </p>
                  )}
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                Quản lý nguyên vật liệu theo lô - HSD
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 flex justify-end items-center gap-3">
        ...
        <button
          ...
          disabled={saving || loadingGroups || materialGroups.length === 0}
