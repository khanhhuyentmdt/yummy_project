...
from api.models import SemiFinishedProductBOM


class SemiFinishedProductBOMReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SemiFinishedProductBOM
        fields = ['id', 'raw_material_id', 'raw_material_name', 'quantity', 'unit']


class SemiFinishedProductBOMWriteSerializer(serializers.Serializer):
