...
class PurchaseOrder(models.Model):
    ...
    order_date = models.DateField(null=True, blank=True, verbose_name='Ngay dat hang')
    expected_delivery_date = models.DateField(null=True, blank=True, verbose_name='Ngay ve kho du kien')
...
class PurchaseOrderItem(models.Model):
    ...
    quantity = models.DecimalField(max_digits=12, decimal_places=3, default=0, verbose_name='So luong')
    unit = models.CharField(max_length=50, blank=True, default='', verbose_name='Don vi tinh')
    unit_price = models.DecimalField(max_digits=14, decimal_places=0, default=0, verbose_name='Don gia')
    line_total = models.DecimalField(max_digits=14, decimal_places=0, default=0, verbose_name='Thanh tien')
    ...
    def __str__(self):
        return f'{self.purchase_order.code} - {self.material.name}'
